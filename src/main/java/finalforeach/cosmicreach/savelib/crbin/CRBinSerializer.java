...
public class CRBinSerializer
{
	...
	public static <T> void registerDefaultClassSerializer(Class<T> clazz,
			TriConsumer<CRBinSerializer, String, T> consumer)
	{
	...
	public void autoWriteDifference(Object prototype, Object obj)
	{
		...
		if (!prototypeClazz.isInstance(obj))
		{
			throw new RuntimeException(
					"Object is not an instance of the class or instance of a subclass of the prototype's class.");
		}
			...
			for (Field field : fields)
			{
				if (field.isAnnotationPresent(CRBSerialized.class))
				{
					...
					try
					{
						...
						{
							writeLong(name, field.getLong(obj));
						} else if (type == float.class)
						{
